...
task main()
{
    ...
    while(limit == 0)
    {
        ...
        {
            motor[leftMotor] = 50*abs(cosDegrees(SensorValue[rightEncoder]-SensorValue[leftEncoder]-ratio)); //Similar function as above
            motor[rightMotor] = 50; //Sets the speed of the right wheels
        }
