...
#pragma config(Motor,  port6,           scissorLift1,  tmotorVex393_MC29, openLoop) //No longer exists.
#pragma config(Motor,  port7,           scissorLift2,  tmotorVex393_MC29, openLoop, reversed) //Both scissor lifts will be port 7
...
//left back wheel goes to port 4
//port 6 is the back right wheel
...
task main()
{
	while (1 == 1)
	{
		motor[RWheel] = vexRT(Ch2)*-1; //-2? lol
