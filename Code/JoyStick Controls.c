...
#pragma config(Motor,  port3,           RFWheel,       tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           LBWheel,       tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           LFWheel,       tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           RBWheel,       tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           scissorLift,   tmotorVex393_MC29, openLoop, reversed)
