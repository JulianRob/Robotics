#pragma config(Motor,  port2,           clawGrip,      tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port10,           scissorLift1,  tmotorVex393_MC29, openLoop)
